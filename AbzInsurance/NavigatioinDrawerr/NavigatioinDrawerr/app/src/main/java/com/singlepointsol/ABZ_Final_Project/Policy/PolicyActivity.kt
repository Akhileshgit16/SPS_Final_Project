package com.singlepointsol.ABZ_Final_Project.Policy
    ...
    private fun savePolicy() {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                Log.d("PolicyActivity", "Attempting to add policy with No: $policyNo, Data: $policyNo")
    ...
    private fun updatePolicy() {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                Log.d("PolicicyActivity", "Attempting to update policy with ID: $policyNo, Payload: $updatePolicy")
